...
module.exports = {
  ...
  updateDeviceId: function(username, deviceId) {
  ...
  getEvents: function(participantId) {
  ...
  getParticipant: function(deviceId) {
  ...
  getCheckinStatus: function(deviceId, eventId) {
  ...
  checkinUser: function(deviceId, callback) {
